...
(deftest input-stream-tests
  (are [expected-type file-path] (= expected-type (surykatka/get-file-type (BufferedInputStream. (FileInputStream. (File. ^String file-path)))))
                                 :7z "test/resources/file.7z"
                                 :bmp "test/resources/file.bmp"
                                 :db "test/resources/file.db"
                                 :gif "test/resources/file.gif"
...
(deftest get-mime-input-stream
  (are [expected-type file-path] (= expected-type (surykatka/get-mime (FileInputStream. (File. ^String file-path))))
                                 "application/7z" "test/resources/file.7z"
                                 "application/gzip" "test/resources/file.gz"
                                 "application/pdf" "test/resources/file.pdf"
                                 "application/postscript" "test/resources/file.ps"
...
(deftest input-stream-does-not-verify-footer
  (are [file-path] (= :jpeg (surykatka/get-file-type (FileInputStream. (File. ^String file-path))))
                   "test/resources/file.wrong-footer.jpg"))